        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 auto-rows-[180px] sm:auto-rows-[280px]">
          ...
          <TiltCard className="sm:col-span-2 sm:row-span-2">
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center opacity-40 md:opacity-10 group-hover:opacity-30 transition-all duration-700 pointer-events-none scale-50 md:scale-100">
                <motion.svg
          ...
          <TiltCard className="sm:col-span-2">
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center opacity-40 md:opacity-20 group-hover:opacity-60 transition-all duration-700 z-10 pointer-events-none scale-50 md:scale-100">
                {/* @ts-ignore */}
                <lord-icon
          ...
          <TiltCard>
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center opacity-40 md:opacity-20 group-hover:opacity-80 transition-all duration-700 z-10 pointer-events-none scale-50 md:scale-100">
                {/* @ts-ignore */}
                <lord-icon
