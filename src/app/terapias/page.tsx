...
const StandardBookingForm = dynamic(
    () => import('@/components/StandardBookingForm').then(mod => ({ default: mod.StandardBookingForm })),
    { ssr: false }
);
                    ...
                    {therapies.map((therapy) => (
                        <TiltCard key={therapy.id} className="w-full">
                            ...
                            >
                                ...
                                <div className={`p-8 md:p-10 flex flex-col md:flex-row items-start md:items-center gap-6 relative z-10`}>
                                        ...
                                        >
                                            ...
                                            <div className="px-8 pb-10 md:px-10 flex justify-center md:justify-start">
                                                <motion.button
                                                    ...
                                                    className="bg-solar text-black px-8 py-3 rounded-full font-bold text-sm uppercase tracking-wider shadow-lg shadow-solar/20 hover:shadow-solar/40 transition-all duration-300 flex items-center gap-2"
                                                >
                                                    Agendar cita
